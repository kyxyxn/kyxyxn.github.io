...
## Compliance and ...
For simplicity, let's discuss IV estimation for a binary IV ($$Z=\{0, 1\}$$) and binary treatment ($$D=\{0, 1\}$$). A subject in a study with binary IV and treatment can be classified into one of four latent compliance classes based on the joint values of potential treatment received[^1]. The four compliance classes are referred to as compliers, never-takers, always-takers, and defiers. Compliers refer to indivudlas who adhere to the treatment assignment (i.e., they are assigned to the treatment group and adhere to the treatment). Never-takers are individuals who never take the treatment regardless of their assignment to the treatment group. Always-takers are individuals who always take the treatment regardless of not being assigned to the treatment group. Defiers are individuals who do the opposite of the assignment.

Let $$D^z$$ be the $$N$$-dimensional vector of potential treatment under IV assignment $$z$$ with elements $$D^z_i, \ i=1,...,N, \ D^z_i=1$$ or $$0$$ according to whether person $$i$$ would receive treatment level $$1$$ or $$0$$ under IV assignment $$z$$. In other words, $$D^0_i$$ means $$i$$ has $$z=0$$ and $$D^1_i$$ means $$i$$ has $$z=1$$. $$D^0_i=0$$ means that a person $$i$$ who has $$z=0$$ did not receive treatment, while $$D^0_i=1$$ means that they received treatment. The four compliance classes can each be represented as follows:
