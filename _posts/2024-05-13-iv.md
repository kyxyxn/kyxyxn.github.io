...
We assume that the correlation between $$\eta_i$$ and the treatmetn $$s_i$$ arises solely because of the control variables $$A_i$$. This implies that $$E\[s_i\nu_i\] = 0$$, meaning there is no corerlation between the treatment $$s_i$$ and the residual error term $$\nu_i$$.
...
Based on the exclusion restriction, the instrument $$z_i$$ affects the outcome $$Y_i$$ only through the treatment $$s_i$$. This implies: $$Cov(\eta_i, z_i) = 0$$
